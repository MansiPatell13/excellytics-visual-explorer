      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 space-y-3">
            <button className="w-full text-white px-4 py-2 rounded-lg font-medium transition-colors bg-teal-800 hover:bg-teal-700">
              Upgrade to Pro
            </button>
            <button onClick={onCreateNew} className="w-full px-4 py-2 rounded-lg font-medium transition-colors bg-teal-600 hover:bg-teal-500 text-slate-50">
              Create new
            </button>
          </div>
