      ...
      <div className="relative min-h-screen flex items-center justify-center px-4 py-20">
        ...
        duration: 0.8
          ...
          <div className="glass-card p-8 rounded-2xl shadow-2xl border border-white/20 dark:border-white/10">
            ...
            {/* Email Step */}
            {step === 'email' && <motion.form initial={{
            opacity: 0,
            y: 10
          }} animate={{
            opacity: 1,
            ...
            duration: 0.5
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" name="email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your email" required className="h-12 border-2 focus:border-excellytics-green-500 dark:focus:border-excellytics-green-400 transition-all duration-200 px-[8px]" />
                </div>
            ...
            {step === 'security' && <motion.form initial={{
            opacity: 0,
            y: 10
          }} animate={{
            opacity: 1,
            ...
            delay: 0.5,
            duration: 0.5
          }} onSubmit={handleSecuritySubmit} className="space-y-6">
                <div className="space-y-2">
                ...
                <div className="flex gap-3">
                  <Button type="button" onClick={resetForm} variant="outline" className="flex-1 h-12 border-2 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200">
                    Back
                  </Button>
                  <Button type="submit" className="flex-1 h-12 bg-gradient-to-r from-excellytics-green-500 to-excellytics-blue-500 hover:from-excellytics-green-600 hover:to-excellytics-blue-600 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]">
                    Verify
                  </Button>
                </div>
              </motion.form>}
            ...
            {/* Success Step */}
            {step === 'success' && <motion.div initial={{
            opacity: 0,
            y: 10
          }} animate={{
            opacity: 1,
            ...
            duration: 0.5
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  <button onClick={resetForm} className="text-excellytics-green-600 dark:text-excellytics-green-400 hover:text-excellytics-green-700 dark:hover:text-excellytics-green-300 transition-colors duration-200 font-medium">
                    try again
                  </button>
                </p>
              </motion.div>}
            ...
            duration: 0.5
              ...
              <Link to="/signin" className="text-gray-600 dark:text-gray-300 hover:text-excellytics-green-600 dark:hover:text-excellytics-green-400 transition-colors duration-200 font-medium">
                ← Back to Sign In
              </Link>
            </motion.div>
          </div>
