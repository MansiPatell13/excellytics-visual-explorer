...
const SignIn = () => {
  ...
  const handleSubmit = e => {
    ...
    // Store mock JWT and user in localStorage
    const mockJwt = 'mock-jwt-token';
    const mockUser = {
      login: formData.email.split('@')[0],
      name: formData.email.split('@')[0],
      avatar_url: `https://api.dicebear.com/7.x/identicon/svg?seed=${encodeURIComponent(formData.email)}`,
      id: Date.now(),
      html_url: '#',
        ...
        duration: 0.8
          ...
          <div className="glass-card p-8 rounded-2xl shadow-2xl border border-white/20 dark:border-white/10">
            ...
            duration: 0.5
              ...
              <Button onClick={handleGoogleSignIn} variant="outline" className="w-full h-12 border-2 hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-200">
              ...
              <Button onClick={handleGithubSignIn} variant="outline" className="w-full h-12 border-2 hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-200">
            ...
            duration: 0.5
              ...
              <div className="space-y-2">
                ...
                <Input id="password" name="password" type="password" value={formData.password} onChange={handleInputChange} placeholder="Enter your password" required className="h-12 border-2 focus:border-excellytics-green-500 dark:focus:border-excellytics-green-400 transition-all duration-200 px-[8px]" />
              </div>

              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input type="checkbox" className="rounded border-gray-300 text-excellytics-green-500 focus:ring-excellytics-green-500" />
                  <span className="text-gray-600 dark:text-gray-300">Remember me</span>
                </label>
                
                <Link to="/forgot-password" className="text-excellytics-green-600 dark:text-excellytics-green-400 hover:text-excellytics-green-700 dark:hover:text-excellytics-green-300 transition-colors duration-200 font-medium">
                  Forgot password?
                </Link>
              </div>
            ...
            duration: 0.5
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                <Link to="/signup" className="text-excellytics-green-600 dark:text-excellytics-green-400 hover:text-excellytics-green-700 dark:hover:text-excellytics-green-300 transition-colors duration-200 font-medium">
                  Sign up
                </Link>
              </p>
            </motion.div>
