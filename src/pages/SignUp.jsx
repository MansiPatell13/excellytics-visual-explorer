          ...
          <div className="glass-card p-8 rounded-2xl shadow-2xl border border-white/20 dark:border-white/10">
            ...
            >
              <Button
                ...
                variant="outline"
                className="w-full h-12 border-2 hover:bg-white/10 dark:hover:bg-white/5 transition-all duration-200"
              >
            ...
            >
              ...
              <div className="flex items-start space-x-2 text-sm">
                <input
                  type="checkbox"
                  className="mt-0.5 rounded border-gray-300 text-excellytics-green-500 focus:ring-excellytics-green-500"
                  required
                />
